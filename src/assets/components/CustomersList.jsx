            ...
            <Row>
                <Col className='d-flex align-items-center'>
                  <Stack className='d-flex justify-content-center w-100'>
                      <Typography variant='h3' className='bg-success bg-opacity-50 p-3 rounded-3 fw-bold mb-2'>Customers List</Typography>
                      <Typography variant='body2' className='bg-success bg-opacity-50 p-3 rounded-3 fw-medium mb-3'>You can view the list of customers here.</Typography>
                  </Stack>
                </Col>
            </Row>
            <Row>
